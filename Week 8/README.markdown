<div align="center">
    <h1 style="text-align: center;font-weight: bold">Praktikum 8<br>SysOp</h1>
...
Variabel merupakan  dasar dari setiap bahasa pemrograman. Pemrograman skrip shell dan bash menawarkan variabel, sama seperti bahasa lainnya.

Variabel berfungsi sebagai wadah yang digunakan untuk menyimpan data dalam pemrograman. Ini mencakup penunjuk ke lokasi memori dari data tersebut.
...
- VariableName:
Ini adalah nama dari variabel, yang dapat mengandung kombinasi apa pun dari huruf alfabet (a sampai z, A sampai Z), angka (0 sampai 9), dan garis bawah (_).

- VariableValue:
Adalah nilai yang disimpan dalam sebuah variabel, dan bisa berupa rangkaian angka atau boolean. Simbol sama dengan (=) digunakan untuk menetapkan nilai ke sebuah variabel.
...
Terkadang, Anda mungkin ingin membaca isi file dengan pemrograman Bash.

Ada beberapa cara yang bisa di lakukan.
Syntax
...
Komentar adalah pernyataan kode yang berisi teks yang dapat dibaca manusia, dan diabaikan oleh Bash saat menjalankan skrip. Hampir semua bahasa pemrograman memiliki fitur komentar, yang berfungsi untuk memberikan penjelasan tentang baris kode atau pernyataan tertentu.
...
Array dalam Bash adalah sebuah variabel yang dapat menyimpan lebih dari satu nilai.

Misalkan, Anda memiliki daftar angka 1 2 3 ... 10 dan ingin menyimpan angka-angka tersebut dalam skrip Bash.
...
![App Screenshot](image/ar%201.png)

Output :

![App Screenshot](image/ar%202.png)
...
![App Screenshot](image/ar%203..png)

Output :

![App Screenshot](image/ar%204.png)
...
![App Screenshot](image/ar%205.png)

Output :

![App Screenshot](image/ar%206.png)
...
![App Screenshot](image/ar%207.png)

Output :

![App Screenshot](image/ar%208.png)

Cara lain untuk mencetak indeks dan elemen array menggunakan for loop

Syntax :

![App Screenshot](image/ar%209.png)

Output :

![App Screenshot](image/ar%2010.png)
...
![App Screenshot](image/ar%2011.png)

Output :

![App Screenshot](image/ar%2012.png)
...
![App Screenshot](image/b2.png)

Output :

![App Screenshot](image/b1.png)
...
![App Screenshot](image/b4.png)

Output:

![App Screenshot](image/b3.png)
...
Tanda kutip tunggal (') digunakan untuk mendefinisikan string tanpa makna khusus. Ini berarti semua variabel dan ekspansi tidak diinterpretasikan dan mencetak string literal yang sama.

Syntax :

![App Screenshot](image/b6.png)

Output :

![App Screenshot](image/b5.png)
...
![App Screenshot](image/b8.png)

Output :

![App Screenshot](image/b7.png)
...
![App Screenshot](image/b10.png)

Output:

![App Screenshot](image/b9.png)
...
![App Screenshot](image/b12.png)

Output :

![App Screenshot](image/b11.png)
...
![App Screenshot](image/b14.png)


Output :

![App Screenshot](image/b13.png)
...
![App Screenshot](image/b16.png)

Output :

![App Screenshot](image/b15.png)
...
![App Screenshot](image/b18.png)

Output :

![App Screenshot](image/b17.png)
...
![App Screenshot](image/b22.png)

Output :

![App Screenshot](image/b21.png)
...
![App Screenshot](image/b24.png)

Output :

![App Screenshot](image/b23.png)
...
![App Screenshot](image/b26.png)

Output :

![App Screenshot](image/b27.png)
...
![App Screenshot](image/b28.png)

**Cara meneruskan parameter ke suatu fungsi**

![App Screenshot](image/b29.png)

Parameter dapat diakses menggunakan $1 $2 $3.. $n

![App Screenshot](image/b30.png)
...
![App Screenshot](image/b32.png)

Output :

![App Screenshot](image/b31.png)

Contoh lain melibatkan penggabungan string ke variabel yang sama dan mencetaknya ke konsol:

Syntax :

![App Screenshot](image/b34.png)

Output :

![App Screenshot](image/b33.png)
...
![App Screenshot](image/b36.png)

Output :

![App Screenshot](image/b35.png)
...
![App Screenshot](image/b38.png)

Output :

![App Screenshot](image/b37.png)
...
![App Screenshot](image/b40.png)

Output :

![App Screenshot](image/b39.png)
...
![App Screenshot](image/op1.png)

example

Syntax :

![App Screenshot](image/op3.png)

Output :

![App Screenshot](image/op2.png)
...
![App Screenshot](image/cd1.png)

Output :

![App Screenshot](image/cd2.png)
...
![App Screenshot](image/cd3.png)

Output :

![App Screenshot](image/cd4.png)
...
![App Screenshot](image/cd6.png)

Output :

![App Screenshot](image/cd7.png)
...
![App Screenshot](image/fn1.png)

Output :

![App Screenshot](image/fn2.png)
...
![App Screenshot](image/fn3.png)

Output :

![App Screenshot](image/fn4.png)
...
![App Screenshot](image/fn5.png)

Output :

![App Screenshot](image/fn6.png)
...
![App Screenshot](image/sl1.png)

Output :

![App Screenshot](image/sl2.png)
...
![App Screenshot](image/sl4.png)

**Menggunakan Perintah expr Metode lain melibatkan penggunaan perintah expr untuk mencari panjang string.**

Syntax :

![App Screenshot](image/sl5.png)

Output :

![App Screenshot](image/sl6.png)

**menggunakan perintah awk Awk menyediakan cara lain untuk menghitung panjang string menggunakan ekspresi.**

Syntax :

![App Screenshot](image/sl7.png)

Output :

![App Screenshot](image/sl8.png)

## Bash - Bashrc

File .bashrc adalah file skrip Bash yang dieksekusi dalam kasus-kasus berikut:

Saat menggunakan eksekusi skrip Bash: Ketika Anda menjalankan skrip Bash secara manual di terminal, skrip tersebut tidak memicu eksekusi .bashrc.
Saat shell Bash dibuka dan dimulai secara interaktif: Ketika Anda membuka terminal dan mulai mengetikkan perintah, ini adalah lingkungan Bash interaktif. Dan pada saat inilah file .bashrc dieksekusi.
...
![App Screenshot](image/bash1.png)
...
![App Screenshot](image/bash2.png)
...
![App Screenshot](image/to1.png)

Output :

![App Screenshot](image/to2.png)
...
![App Screenshot](image/to5.png)

Output :

![App Screenshot](image/to6.png)

## Bash - Lowercase

Tutorial ini menjelaskan bagaimana mengubah string menjadi huruf kecil dalam skrip Bash.
Sebagai contoh, jika string masukan adalah "Hello World Welcome", outputnya akan menjadi "hello world welcome". Ada beberapa cara untuk mencapai hal ini, tergantung pada jenis dan versi Bash yang digunakan.
...
![App Screenshot](image/lc1.png)

Output :

![App Screenshot](image/lc2.png)

Sebagai alternatif, Anda dapat menggunakan.

Syntax :

![App Screenshot](image/lc9.png)
...
![App Screenshot](image/lc3.png)

Output :

![App Screenshot](image/lc4.png)
...
![App Screenshot](image/lc5.png)

Output :

![App Screenshot](image/lc6.png)

Syntax :

![App Screenshot](image/lc7.png)

Output :

![App Screenshot](image/lc8.png)

Di sini, ${msg,,} menggunakan opsi ,, untuk mengonversi variabel menjadi huruf kecil.

## Bash - Uppercase

Dalam Bash, string huruf besar (uppercase string) adalah string yang seluruh hurufnya ditulis dalam huruf besar (uppercase).

Misalnya, jika string masukan adalah "Hello World Welcome", outputnya menjadi "HELLO WORLD WELCOME".

Ada beberapa metode untuk mengubah string menjadi huruf besar di Bash, tergantung pada jenis dan versi Bash yang digunakan.
...
![App Screenshot](image/uc1.png)

Output :

![App Screenshot](image/uc2.png)

Cara lain untuk mengganti kode di atas

Syntax :

![App Screenshot](image/uc3.png)

Output :

![App Screenshot](image/uc4.png)
...
![App Screenshot](image/uc6.png)

Output :

![App Screenshot](image/uc7.png)
...
![App Screenshot](image/uc8.png)

Output :

![App Screenshot](image/uc9.png)
...
![App Screenshot](image/sub1.png)

Output :

![App Screenshot](image/sub2.png)
...
![App Screenshot](image/sub3.png)

**Gunakan perintah grep**

Perintah grep digunakan untuk mencari string tertentu, disalurkan ke string utama untuk perbandingan.

![App Screenshot](image/sub4.png)

## Bash - Variable Set
  Dalam skrip Bash, Anda dapat mengecek keberadaan substring (sub-string) di dalam string (untaian karakter) menggunakan dua metode utama:
...
![App Screenshot](image/vs7.png)

Output :

![App Screenshot](image/vs8.png)

Opsi penggunaan -z lainnya untuk memeriksa variabel disetel dan kosong atau tidak kosong menggunakan kode di bawah ini

Syntax :

![App Screenshot](image/vs9.png)

Output :

![App Screenshot](image/vs10.png)

## Bash - Iterate Nos

Dalam contoh ini,  terdapat cara menghasilkan urutan rentang angka dan simpan dalam variabel.
Berikut adalah contoh bagaimana menghasilkan urutan rentang angka dan menyimpannya dalam sebuah variabel.Terkadang, kita ingin menghasilkan nama file dengan nama yang mengandung angka yang dihasilkan dari urutan atau rentang angka.

Syntax :

![App Screenshot](image/in1.png)

Output :

![App Screenshot](image/in2.png)

- menggunakan perulangan for

Syntax :

![App Screenshot](image/in3.png)

Output :

![App Screenshot](image/in4.png)

- while loop

Syntax :

![App Screenshot](image/in5.png)

Output :

![App Screenshot](image/in6.png)